...
//    class DebugInterpretor : IDebugInterpretor {
//        public event EventHandler<BreakpointHitEventArgs> BreakpointHit;
//        void OnBreakpointHit( Handle<VMILMessageHandler> messageHandler, int position ) {
...
//        public InterpretorData Data { get; private set; }
//        public DebugExecutionStack Stack { get { return (DebugExecutionStack) Data.Stack; } }

//        Handle<AppObject> finalResult = null;

//        static Action<DebugInterpretor> handleException = ( _this ) => {
...
//            waitToStep = new EventWaitHandle( true, EventResetMode.ManualReset ),
...
//        DebugInterpretor( int id, Handle<AppObject> entrypointObject, Handle<MessageHandlerBase> entrypoint, params Handle<AppObject>[] args )
//            : this( id ) {
...
//        DebugInterpretor( int id ) {
//            Data = new InterpretorData();
//            Data.AttachedTo = this;
//            Data.Id = id;
//            Data.Stack = new DebugExecutionStack( 100 );
//        }

//        DebugInterpretor( InterpretorData data ) {
//            Data = data;
//            Data.Stack = new DebugExecutionStack( data.Stack );
//        }
...
//        #region Debug IInterpretor Members
...
//        public DebugInterpretorPosition Break() {
//            isStepping = true;
//            waitToStep.Reset();
//            waitOnStep.WaitOne();
//            return new DebugInterpretorPosition( Data.Handler.To<VMILMessageHandler>(), Data.PC );
//        }

//        public DebugInterpretorPosition StepOne() {
//            waitToStep.Set();
//            waitOnStep.WaitOne();
//            waitToStep.Reset();
//            return new DebugInterpretorPosition( Data.Handler.To<VMILMessageHandler>(), Data.PC );
...
//                waitOnStep.Set();
//                state = InterpretorState.Blocked;
//                isBlocked = true;
//            }
//            waitToStep.WaitOne();
//            lock (externalWaitObject) {
...
//            lock (externalWaitObject) {
//                List<Handle<VMILMessageHandler>> l;
//                if (!breakpoints.TryGetValue( Data.PC, out l ))
//                    return;

//                if (!l.Any( h => h.Start == Data.Handler.Start ))
//                    return;
//            }
//            OnBreakpointHit( Data.Handler.To<VMILMessageHandler>(), Data.PC );
//            WaitStep();
//        }
...
//                return new DebugInterpretor( id, entrypointObject, entrypoint, args );
//            }

//            public IInterpretor CreateInstance( int id ) {
//                return new DebugInterpretor( id );
//            }
//        }
//    }
//}
